...
def _render_brief(brief, skill_warnings, comms_o, comms_d):
    ...
    with dl_c1:
        ...
        try:
            cs_bytes = generate_cheatsheet(
                ...
                aircraft=get_aircraft(st.session_state.get("aircraft_type")),
            )
            st.download_button(
        ...
        if st.button("GO — Save and create flight log", type="primary",
            ...
            try:
                ...
                flight = create_flight(
                    ...
                    aircraft_type=st.session_state.get("aircraft_type"),
                    tail_number=st.session_state.get("aircraft_tail"),
